...
trait V2Tables$ {
   ...
   *
   * @param abint     Database column abint SqlType(CHAR), Length(2,false), Default(None)
   * @param aikz      Database column aikz SqlType(CHAR), Default(None)
   * @param ktxt      Database column ktxt SqlType(CHAR), Length(10,false), Default(None)
   * @param dtxt      Database column dtxt SqlType(CHAR), Length(25,false), Default(None)
   * @param ltxt      Database column ltxt SqlType(CHAR), Length(100,false), Default(None)
   * @param astat     Database column astat SqlType(CHAR), Length(2,false), Default(None)
   * @param hrst      Database column hrst SqlType(CHAR), Length(10,false), Default(None)
   * @param part      Database column part SqlType(CHAR), Length(2,false), Default(None)
   * @param anzstg    Database column anzstg SqlType(SMALLINT), Default(None)
   * @param kzfaarray Database column kzfaarray SqlType(CHAR), Length(10,false), Default(None)
   * @param magLaa    Database column mag_laa SqlType(CHAR), Default(None)
   * @param sortkz1   Database column sortkz1 SqlType(CHAR), Length(2,false), Default(None)
   * @param anzstgmin Database column anzstgmin SqlType(SMALLINT), Default(None)
   * @param sprache   Database column sprache SqlType(CHAR), Length(3,false), Default(None)
   * @param refabint  Database column refabint SqlType(CHAR), Length(2,false), Default(None) */
  case class KAbintwebRow(abint: Option[String] = None, aikz: Option[Char] = None, ktxt: Option[String] = None, dtxt: Option[String] = None, ltxt: Option[String] = None, astat: Option[String] = None, hrst: Option[String] = None, part: Option[String] = None, anzstg: Option[Short] = None, kzfaarray: Option[String] = None, magLaa: Option[Char] = None, sortkz1: Option[String] = None, anzstgmin: Option[Short] = None, sprache: Option[String] = None, refabint: Option[String] = None)
  ...
  class KAbintweb(_tableTag: Tag) extends Table[KAbintwebRow](_tableTag, "k_abintweb") {
  ...
  class KAbstgvweb(_tableTag: Tag) extends Table[KAbstgvwebRow](_tableTag, "k_abstgvweb") {
    ...
    /** Database column abstgv SqlType(CHAR), Length(10,false), Default(None) */
   ...
   *
   * @param akfz                 Database column akfz SqlType(CHAR), Length(3,false)
   * @param aikz                 Database column aikz SqlType(CHAR)
   * @param ktxt                 Database column ktxt SqlType(CHAR), Length(10,false)
   * @param dtxt                 Database column dtxt SqlType(CHAR), Length(25,false)
   * @param ltxt                 Database column ltxt SqlType(CHAR), Length(255,false)
   * @param astat                Database column astat SqlType(CHAR), Length(3,false)
   * @param erdteil              Database column erdteil SqlType(CHAR), Length(4,false)
   * @param egmitgl              Database column egmitgl SqlType(CHAR)
   * @param isoCode              Database column iso_code SqlType(CHAR), Length(2,false)
   * @param sprache              Database column sprache SqlType(CHAR), Length(3,false)
   * @param refakfz              Database column refakfz SqlType(CHAR), Length(3,false)
   * @param oecd                 Database column oecd SqlType(CHAR)
   * @param staatsangehoerigkeit Database column staatsangehoerigkeit SqlType(CHAR), Length(50,false) */
  case class KAkfzRow(akfz: String, aikz: Char, ktxt: String, dtxt: String, ltxt: String, astat: String, erdteil: String, egmitgl: Char, isoCode: String, sprache: String, refakfz: String, oecd: Char, staatsangehoerigkeit: String)
  ...
  class KAkfz(_tableTag: Tag) extends Table[KAkfzRow](_tableTag, "k_akfz") {
   ...
   * @param ktxt      Database column ktxt SqlType(CHAR), Length(10,false), Default(None)
   * @param dtxt      Database column dtxt SqlType(CHAR), Length(25,false), Default(None)
   * @param ltxt      Database column ltxt SqlType(CHAR), Length(255,false), Default(None)
   * @param astat     Database column astat SqlType(CHAR), Length(2,false), Default(None)
   * @param bonussem  Database column bonussem SqlType(SMALLINT), Default(None)
   * @param autohzbwd Database column autohzbwd SqlType(CHAR), Default(None) */
  case class KHzbartRow(hzbart: Option[String] = None, aikz: Option[Char] = None, ktxt: Option[String] = None, dtxt: Option[String] = None, ltxt: Option[String] = None, astat: Option[String] = None, bonussem: Option[Short] = None, autohzbwd: Option[Char] = None)
  ...
  class KHzbart(_tableTag: Tag) extends Table[KHzbartRow](_tableTag, "k_hzbart") {
    ...
    /** Database column dtxt SqlType(CHAR), Length(25,false), Default(None) */
    val dtxt: Rep[Option[String]] = column[Option[String]]("dtxt", O.Length(25, varying = false), O.Default(None))
    /** Database column ltxt SqlType(CHAR), Length(255,false), Default(None) */
    val ltxt: Rep[Option[String]] = column[Option[String]]("ltxt", O.Length(255, varying = false), O.Default(None))
    /** Database column astat SqlType(CHAR), Length(2,false), Default(None) */
    val astat: Rep[Option[String]] = column[Option[String]]("astat", O.Length(2, varying = false), O.Default(None))
    /** Database column bonussem SqlType(SMALLINT), Default(None) */
    val bonussem: Rep[Option[Short]] = column[Option[Short]]("bonussem", O.Default(None))
    /** Database column autohzbwd SqlType(CHAR), Default(None) */
   ...
   *
   * @param ikfz  Database column ikfz SqlType(CHAR), Length(4,false), Default(None)
   * @param aikz  Database column aikz SqlType(CHAR), Default(None)
   * @param ktxt  Database column ktxt SqlType(CHAR), Length(10,false), Default(None)
   * @param dtxt  Database column dtxt SqlType(CHAR), Length(25,false), Default(None)
   * @param ltxt  Database column ltxt SqlType(CHAR), Length(255,false), Default(None)
   * @param astat Database column astat SqlType(CHAR), Length(5,false), Default(None)
   * @param bland Database column bland SqlType(CHAR), Length(2,false), Default(None) */
  case class KIkfzRow(ikfz: Option[String] = None, aikz: Option[Char] = None, ktxt: Option[String] = None, dtxt: Option[String] = None, ltxt: Option[String] = None, astat: Option[String] = None, bland: Option[String] = None)
  ...
  class KIkfz(_tableTag: Tag) extends Table[KIkfzRow](_tableTag, "k_ikfz") {
    def * = (ikfz, aikz, ktxt, dtxt, ltxt, astat, bland) <> (KIkfzRow.tupled, KIkfzRow.unapply)

    /** Database column ikfz SqlType(CHAR), Length(4,false), Default(None) */
    ...
    /** Database column ltxt SqlType(CHAR), Length(255,false), Default(None) */
    val ltxt: Rep[Option[String]] = column[Option[String]]("ltxt", O.Length(255, varying = false), O.Default(None))
    /** Database column astat SqlType(CHAR), Length(5,false), Default(None) */
    val astat: Rep[Option[String]] = column[Option[String]]("astat", O.Length(5, varying = false), O.Default(None))
    /** Database column bland SqlType(CHAR), Length(2,false), Default(None) */
   ...
   *
   * @param ikfzha   Database column ikfzha SqlType(CHAR), Length(6,false), Default(None)
   * @param aikz     Database column aikz SqlType(CHAR), Default(None)
   * @param ktxt     Database column ktxt SqlType(CHAR), Length(10,false), Default(None)
   * @param dtxt     Database column dtxt SqlType(CHAR), Length(25,false), Default(None)
   * @param ltxt     Database column ltxt SqlType(CHAR), Length(255,false), Default(None)
   * @param astat    Database column astat SqlType(CHAR), Length(4,false), Default(None)
   * @param hsbetrnr Database column hsbetrnr SqlType(CHAR), Length(20,false), Default(None) */
  case class KIkfzhaRow(ikfzha: Option[String] = None, aikz: Option[Char] = None, ktxt: Option[String] = None, dtxt: Option[String] = None, ltxt: Option[String] = None, astat: Option[String] = None, hsbetrnr: Option[String] = None)
  ...
  class KIkfzha(_tableTag: Tag) extends Table[KIkfzhaRow](_tableTag, "k_ikfzha") {
    def * = (ikfzha, aikz, ktxt, dtxt, ltxt, astat, hsbetrnr) <> (KIkfzhaRow.tupled, KIkfzhaRow.unapply)

    /** Database column ikfzha SqlType(CHAR), Length(6,false), Default(None) */
    ...
    /** Database column ltxt SqlType(CHAR), Length(255,false), Default(None) */
    val ltxt: Rep[Option[String]] = column[Option[String]]("ltxt", O.Length(255, varying = false), O.Default(None))
    /** Database column astat SqlType(CHAR), Length(4,false), Default(None) */
    val astat: Rep[Option[String]] = column[Option[String]]("astat", O.Length(4, varying = false), O.Default(None))
    /** Database column hsbetrnr SqlType(CHAR), Length(20,false), Default(None) */
